...
&& py.test -s -v test_napalm_cfg.py::test_compare_config_inline --test_device nxos \
...
&& py.test -s -v test_napalm_cfg.py::test_commit_config_hostname_merge --test_device nxos \
&& py.test -s -v test_napalm_cfg.py::test_replace_commit_config --test_device nxos \
&& py.test -s -v test_napalm_cfg.py::test_commit_config_hostname --test_device nxos \
