RETURN_CODE=0
py.test -s -v test_napalm_cfg.py::test_compare_config --test_device eos \
&& py.test -s -v test_napalm_cfg.py::test_compare_config_inline --test_device eos \
...
&& py.test -s -v test_napalm_cfg.py::test_commit_config_hostname_merge --test_device eos \
